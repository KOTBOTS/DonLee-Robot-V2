...
async def sub(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[     
          Import.Button("🖥️KOT LINKS", url="https://t.me/KOT_LINKS_TEAM"),
          Import.Button("𝖲𝗎𝗉𝗉𝗈𝗋𝗍 YOUTUBE🤝", url="https://https://youtube.com/channel/UCWBJ4ZVNc4kWoZKp5Y-byHA")
          ],[
          Import.Button("📢𝖴𝗉𝖽𝖺𝗍𝖾𝗌", url="https://t.me/KOT_BOTS"),
          Import.Button("𝖸𝗈𝗎𝖳𝗎𝖻𝖾💞", url="https://youtube.com/channel/UCWBJ4ZVNc4kWoZKp5Y-byHA")
          ],[
          Import.Button("📦TELEGRAM", url="http://t.me/KOT_FREE_DE_LA_HOYA_OFF"),
          Import.Button("SUPPORT😁", url="https://t.me/KOT_REPORS")
          ],[
          Import.Button("𝖢𝗅𝗈𝗌𝖾🗑️", callback_data="close")
          ]]                     
        await bot.send_photo(
...
async def admin(bot, msg):
    button = [[  
       Import.Button("𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾➡️", url="t.me/KOT_FREE_DE_LA_HOYA_OFF")
       ]]
    await msg.reply_text(
